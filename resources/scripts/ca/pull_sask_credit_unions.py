...
def main():
    ap = argparse.ArgumentParser(description="Parse SK credit-union <ul> list into CSV (name,url,abbr,source,).")
    ...
    if not rows:
        sys.stderr.write("No rows parsed. Ensure the HTML contains <ul><li><a href=...> entries.\n")
        sys.exit(2)
