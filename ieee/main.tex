...
% TODO
  ...
  % - add brief security headers + cookies in results (1 or 2 sentences) 
  % - make sure paper says what recommended security cookie attributes are and who advocates for them
...
and error handling \cite{owasp_improper_error_handling,cwe_209,cwe_200}. In addition to information leakage, modern browser-side controls
...
To address these gaps, an automated scanning tool was developed that incorporates the most recent
Canada-focused security guidelines, augmented by more modern standards from OWASP and the Mozilla Developer Network (MDN). 
In particular, we seek to determine whether Canadian authority websites exhibit gaps int the transport layer, 
browser-side controls, vulnerability disclosure, and information leakage.
The scanner was applied to authority and critical-infrastructure websites in Canada, the US, and the UK, 
...
cookie security flag usage across all datasets. 
