...
% \vspace{1em} Next, we probe each origin for the presence of \texttt{security.txt}, 
% ``A File Format to Aid in Security Vulnerability Disclosure'' \cite{rfc9116}.
% \texttt{Security.txt} is a simple 
% specification that provides a means of open vulnerability disclosure and management. 
