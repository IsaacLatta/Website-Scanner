...
The goal of these checks was to answer practical questions, do public-facing services offer modern TLS versions, 
...
\vspace{1em}Second, we scanned each error page for stack traces from widely used backend languages, sourced from the previously mentioned Stack Overflow Survey. For
