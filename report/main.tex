...
\captionof{table}{Redirect resolution outcomes by country and sector. We show the
...
of origins whose inputs were all unreachable from our vantage point.}
...
% HSTS and HTTPS Captions:

% Enforcement overview
% Distribution of HTTPS enforcement outcomes for Canadian public authorities in our scan. Each origin is placed into exactly one of five buckets: HTTPS unreachable (our scanner could not obtain any HTTPS response at all, due to DNS failures, timeouts, TLS handshake or certificate errors, or connections being dropped/blocked), HTTP no redirect (HTTP responded but did not issue an HTTP→HTTPS redirect), Redirect→HTTPS, no HSTS (HTTP redirected to HTTPS but the HTTPS response did not set any Strict-Transport-Security header), Redirect→HTTPS, weak HSTS (HTTP redirected to HTTPS and HSTS was present but did not meet our “strong” criteria), and Redirect→HTTPS, strong HSTS (HTTP redirected to HTTPS and HSTS was configured with max-age ≥ 1 year and includeSubDomains). From our measurement vantage point, sites in the “HTTPS unreachable” bucket effectively do not offer usable HTTPS at the transport layer to a generic client (regardless of whether this is due to a null route, a misconfiguration, or active blocking), whereas the remaining buckets represent progressively stronger enforcement of HTTPS and HSTS.

% HSTS config quality
% HSTS configuration quality among Canadian public authorities that successfully served HTTPS and set any Strict-Transport-Security header. Bars show, as a percentage of HSTS-enabled origins, the share that configured max-age ≥ 1 year, the share that included the includeSubDomains directive, the share that set the preload flag, and the share that met our definition of strong HSTS (both max-age ≥ 1 year and includeSubDomains). This figure distinguishes authorities that merely enable HSTS from those that follow stronger, long-lived policies intended to prevent downgrade and stripping attacks across the whole origin.
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/hop_distribution_all_success.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/resolution_outcomes.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/entry_status_distribution.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/final_status_distribution.png}
% \captionof{figure}{
% This figure shows the distribution of HTTP status codes for the final responses that the scanner received after resolving any redirects. It summarises how often sites eventually returned a success code (2xx), a redirect (3xx), a client error (4xx) such as 404 or 403, or a server error (5xx) such as 500 or 503. In combination with the entry status distribution, it reveals how often a URL ultimately succeeds even if the first response is a redirect or a soft error. }
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/origin_http_timeout_buckets.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/origin_tls_timeout_buckets.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/redirects/origin_http_forbidden_statuses.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/hsts_https/https_enforcement_overview.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/hsts_https/https_reachability.png}
...
%   \begin{minipage}{\plotwidth}
%   \centering
%   \includegraphics[width=\linewidth]{../results/ca/auth/hsts_https/http_to_https_behaviour.png}
...
%   \begin{minipage}{\plotwidth}
%   \centering
%   \includegraphics[width=\linewidth]{../results/ca/auth/hsts_https/hsts_flags_among_hsts_sites.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/hsts_https/hsts_presence_and_strength.png}
...
%   \begin{minipage}{\plotwidth}
%   \centering
%   \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/tls_protocol_support.png}
...
%   %   \begin{minipage}{\plotwidth}
%   %   \centering
%   %   \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/legacy_protocol_exposure.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/negotiated_tls_versions.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/tls13_cipher_categories.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/tls12_cipher_categories.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/tls_cipher/tls12_weak_features.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/securitytxt/securitytxt_presence.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/securitytxt/securitytxt_field_combinations.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/securitytxt/securitytxt_expires_validity.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/securitytxt/securitytxt_locations.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/securitytxt/securitytxt_contact_canonical.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/error_leak/error_leak_tech_topN_all.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/error_leak/error_leak_tech_topN_no_wp_cf_drupal.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/error_leak/error_leak_category_distribution.png}
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_baseline_coverage.png}
% \captionof{figure}{
...
%   \begin{minipage}{\plotwidth}
%   \centering
%   \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_posture_bucket.png}
%   \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_security_rule_ratings.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_security_header_presence.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_revealing_any.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_revealing_topN.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_revealing_count_distribution.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_cookies_flags.png}
% \captionof{figure}{
...
% \begin{minipage}{\plotwidth}
% \centering
% \includegraphics[width=\linewidth]{../results/ca/auth/headers/headers_cookies_ratings.png}
% \captionof{figure}{
...
% Revealing headers per site (0 / 1 / 2 / 3+)
\begin{table}[t]
  \centering
  \caption{Revealing headers per site, by country and sector. 
  Values are the percentage of sites in each dataset that expose 
  0, 1, 2, or 3+ OWASP ``revealing'' headers (e.g., Server, X-Powered-By).}
  \csvreader[
    tabular=llrrrr,
    table head=\toprule Dataset & Sector & 0 & 1 & 2 & 3+ \\\midrule,
    late after line=\\,
    late after last line=\\\bottomrule
    ...
    pct_revealing_3_plus=\PThreePlus
  }{%
    \Dataset & \Sector & \PZero & \POne & \PTwo & \PThreePlus
  }
\end{table}
...
\begin{inlinecap}
\captionof{table}{Presence of core HTTP security headers, by country and sector.
Values are the percentage of sites in each dataset that send each header
at least once on the landing page.}
...
\resizebox{\textwidth}{!}{%
  \csvreader[
    ...
    \Dataset & \Sector &
    \PRef & \PXcto & \PXfo & \PCsp & \PPerm
  }%
}%
\end{inlinecap}


% Cookie security flags (among cookie-setting sites)
\begin{table}[t]
  \centering
  \caption{Cookie usage and security flags, by country and sector.
  ``Sites with cookies'' is the percentage of all sites in the dataset that
  set any cookie on the landing page. The remaining columns are percentages
  computed among those cookie-setting sites.}
  \csvreader[
    tabular=llrrrrr,
    table head=\toprule Dataset & Sector &
      Sites with cookies &
      ...
      HttpOnly &
      SameSite $\geq$ Lax &
      Rec./Suff. cookie \\\midrule,
    late after line=\\,
    late after last line=\\\bottomrule
  ]{../results/comparison/headers/cookie_security_flags_summary.csv}{%
    dataset_label=\Dataset,
    sector_label=\Sector,
    pct_sites_with_cookies=\PCSites,
    pct_secure_among_cookie_sites=\PSec,
    pct_httponly_among_cookie_sites=\PHO,
    pct_samesite_ge_lax_among_cookie_sites=\PSS,
    pct_rec_suff_among_cookie_sites=\PRec
  }{%
    \Dataset & \Sector &
    \PCSites & \PSec & \PHO & \PSS & \PRec
  }
\end{table}

\begin{table}[t]
  \centering
  \caption{Error-page information leaks by country and sector. 
  For each dataset, we report the number of scanned origins and the percentage 
  that leaked any recognizable technology name, an explicit technology/version 
  string, or a full stack trace when probed with a non-existent path.}
  \csvreader[
    tabular=llrrrr,
    table head=\toprule
      Dataset & Sector &
    ...
    dataset_label=\Dataset,
    sector_label=\Sector,
    n_scanned_origins=\Nscan,
    pct_any_tech_leak=\PAny,
    pct_version_leak=\PVer,
    pct_stacktrace=\PStack
  }{%
    \Dataset & \Sector &
    \Nscan & \PAny & \PVer & \PStack
  }
\end{table}
...
\begin{table}[t]
  \centering
  \small
  \caption{Deployment of \texttt{security.txt} by country and sector.
  For each dataset we show the number of scanned origins, the number and
  percentage that expose a usable \texttt{security.txt} file, and, among
  those files, the percentage with a Contact field, an Expires field, and
  the percentage of Expires timestamps that were still valid.}
  \csvreader[
    tabular=llrrrrrr,
    table head=\toprule
      Dataset & Sector &
    ...
    sector_label=\Sector,
    n_origins=\Norig,
    n_with_securitytxt=\Nsec,
    pct_sites_with_securitytxt=\PAny,
    pct_with_contact_among_present=\PContact,
    pct_with_expires_among_present=\PExp,
    pct_valid_expires_among_expires=\PValid
  }{%
    \Dataset & \Sector &
    \Norig & \Nsec & \PAny & \PContact & \PExp & \PValid
  }
\end{table}
